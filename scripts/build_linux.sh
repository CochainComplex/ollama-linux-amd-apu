...
if echo $PLATFORM | grep "," > /dev/null ; then
        ...
        tar c -C ./dist/linux_amd64 --exclude rocm_v7 . | zstd --ultra -22 -T0 >./dist/ollama-linux-amd64.tar.zst
        tar c -C ./dist/linux_amd64 ./lib/ollama/rocm_v7  | zstd --ultra -22 -T0 >./dist/ollama-linux-amd64-rocm.tar.zst
        ...
        tar c -C ./dist/ --exclude rocm_v7 bin lib | zstd --ultra -22 -T0 >./dist/ollama-linux-amd64.tar.zst
        tar c -C ./dist/ ./lib/ollama/rocm_v7  | zstd --ultra -22 -T0 >./dist/ollama-linux-amd64-rocm.tar.zst
fi
